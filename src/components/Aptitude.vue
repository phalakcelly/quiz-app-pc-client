    ...
    <div class="outer">
      ...
      <div class="start" v-if="start">
        <div class="instructions">
          ...
          <p>
            This is a timed quiz with 10 questions each to be answered in 30
            seconds
          </p>
...
<script>
import { getques, resultsubmitandcheck } from "../services/quiz";
export default {
  data() {
    return {
      currentQuestion: 0,
  ...
  methods: {
    ...
    async finalResult() {
      ...
      let date = new Date();
      const display_result = await resultsubmitandcheck({
        email: this.email,
        anslist: this.submitted_anslist,
        date: date,
      });
